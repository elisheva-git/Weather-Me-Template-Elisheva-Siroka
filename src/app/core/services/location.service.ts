...
export class LocationService {
  ...
  getGeoposition(lat:number,lon:number):Observable<Location>{
    return this.httpClient.get<any>(`http://dataservice.accuweather.com/locations/v1/cities/geoposition/search?apikey=${environment.apiKey}&q=${lat}%2C${lon}`)
  }
}
